...
namespace caffe {
	...
	void PadChannelLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
		...
		CHECK_GT(num_channels_to_pad_, 0) << "num channels to pad must be >0";
	}
